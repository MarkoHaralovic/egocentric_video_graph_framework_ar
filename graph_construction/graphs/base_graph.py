...
class Node:
    ...
    attr_feat: Optional[
        torch.Tensor
    ]  # this can be tex embeddings from clip, but i am using multi_hot representation
...
class BaseGraph:
    def __init__(
        self, node_types: List, verbs: Dict, objs: Dict, rels: Dict, attrs: Dict = None
    ):
    ...
    def temporal_edge(self, src_obj_id: int, dst_obj_id: int) -> Edge:
        return Edge(src=src_obj_id, dst=dst_obj_id, rel_idx=None, rel_label="same_as")
